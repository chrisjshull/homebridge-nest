...
Connection.prototype.updateData = function() {
    ...
    return rp({
        ...
        /* rcs_settings['09AC01AC31180349'] = {
            associated_rcs_sensors: [ 'kryptonite.123', 'kryptonite.456' ]
        };

        kryptonite['123'] = { current_temperature: 10, model: 'KR1', serial_number: 'ABC123' };
        kryptonite['456'] = { current_temperature: 20, model: 'KR1', serial_number: 'ABC124' }; */
                        ...
                        rcs_settings[deviceId].associated_rcs_sensors.forEach(sensorName => {
                            ...
                            if (thisSensor) {
                                data.devices['temp_sensors'][sensorId] = {
                                    ...
                                    device_id: sensorId,
                                    software_version: thisSensor.model,
                                    serial_number: thisSensor.serialNumber,
