...
Connection.prototype.update = function(path, data) {
    ...
    if (splitPath[0] == 'structures') {
        ...
        if (splitPath[1] == 'thermostats') {
            ...
            } else if (splitPath[3] == 'away_temperature_high_f' ) {
                serviceType = 'device';
                body = { away_temperature_high_enabled: true, away_temperature_high: fahrenheitToCelsius(data) };
            } else if (splitPath[3] == 'away_temperature_high_c' ) {
                serviceType = 'device';
                body = { away_temperature_high_enabled: true, away_temperature_high: Number(data) };
            } else if (splitPath[3] == 'away_temperature_low_f' ) {
                serviceType = 'device';
                body = { away_temperature_low_enabled: true, away_temperature_low: fahrenheitToCelsius(data) };
            } else if (splitPath[3] == 'away_temperature_low_c' ) {
                serviceType = 'device';
