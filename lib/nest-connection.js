            ...
            swarm.map(unit => unit.split('.')).forEach(unit => {
                try {
                    ...
                    if (deviceType == 'device') {
                        ...
                        let suffixName = '';
                        if (thisDevice.fixture_type == 'LOCATED_MAJOR_FIXTURE_TYPE_DOOR') {
                            suffixName = ' door';
                        } else if (thisDevice.fixture_type == 'LOCATED_MAJOR_FIXTURE_TYPE_WINDOW') {
                            suffixName = ' window';
                        }
                        thisDevice.name += suffixName;
