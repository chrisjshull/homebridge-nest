        ...
        try {
            ...
            if (object && object.message && object.message.length > 0) {
                ...
                if (object) {
                    ...
                    translateProperty(object, 'linus_lock_privacy_mode', null, (privacy_mode, id) => {
                        if (checkDeviceExists(body, id)) {
                            body.yale[id].privacy_mode_on = privacy_mode.data.property.value.privacyModeOn;
                            this.verbose('Protobuf privacy state updated:', privacy_mode.data.property.value.privacyModeOn);
                        }
                    });
