...
NestThermostatAccessory.prototype.setTargetTemperature = function(targetTemperature, callback) {
	if (!['heat', 'cool'].includes(this.device.hvac_mode)) return void callback('Cannot set temperature while in', this.device.hvac_mode, 'mode.');
...
NestThermostatAccessory.prototype.setCoolingThresholdTemperature = function(targetTemperature, callback) {
	if (!['heat-cool', 'eco'].includes(this.device.hvac_mode)) return void callback('Cannot set cooling temperature while in', this.device.hvac_mode, 'mode.');
...
NestThermostatAccessory.prototype.setHeatingThresholdTemperature = function(targetTemperature, callback) {
	if (!['heat-cool', 'eco'].includes(this.device.hvac_mode)) return void callback('Cannot set heating temperature while in', this.device.hvac_mode, 'mode.');
...
NestThermostatAccessory.prototype.setTargetTemperatureDebounced = debounce(function (targetTemperature, callback) {
	return this.updateTargetWithCorrectUnitsAsync("target_temperature_", targetTemperature, "target temperature").asCallback(callback);
}, 5000);

NestThermostatAccessory.prototype.setCoolingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
	var setting = this.device.hvac_mode === 'eco' ? "eco_temperature_high_" : "target_temperature_high_";
...
NestThermostatAccessory.prototype.setHeatingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
	var setting = this.device.hvac_mode === 'eco' ? "eco_temperature_low_" : "target_temperature_low_";
	return this.updateTargetWithCorrectUnitsAsync(setting, targetTemperature, "heating threshold temperature").asCallback(callback);
}, 5000);
