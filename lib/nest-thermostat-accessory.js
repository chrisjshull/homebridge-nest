...
let Away, EcoMode, FanTimerActive, FanTimerDuration, HasLeaf, SunlightCorrectionEnabled, SunlightCorrectionActive, UsingEmergencyHeat;
...
NestThermostatAccessory.prototype.getCoolingThresholdTemperature = function () {
    ...
    default:
        return this.getTemperatureValueInCelsius('target_temperature_high_') || this.getTemperatureValueInCelsius('target_temperature_');
    }
};
...
NestThermostatAccessory.prototype.getHeatingThresholdTemperature = function () {
    ...
    default:
        return this.getTemperatureValueInCelsius('target_temperature_low_') || this.getTemperatureValueInCelsius('target_temperature_');
    }
};
...
NestThermostatAccessory.prototype.setCoolingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
    ...
    return promise.then(() => this.updateTargetWithCorrectUnitsAsync('target_temperature_high_', targetTemperature, 'cooling threshold temperature')).asCallback(callback);
}, 5000);
...
NestThermostatAccessory.prototype.setHeatingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
    ...
    return promise.then(() => this.updateTargetWithCorrectUnitsAsync('target_temperature_low_', targetTemperature, 'heating threshold temperature')).asCallback(callback);
}, 5000);
