...
module.exports = function(exportedTypes) {
	if (exportedTypes && !Accessory) {
		...
		NestThermostatAccessory.prototype.deviceType = 'thermostat';
		NestThermostatAccessory.prototype.deviceGroup = 'thermostats';
	}
...
NestThermostatAccessory.prototype.setTargetTemperature = function (targetTemperature, callback) {
	...
	return this.updateDevicePropertyAsync(key, targetTemperature, prop + "target temperature")
		.asCallback(callback);
};
