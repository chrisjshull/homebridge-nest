...
NestThermostatAccessory.prototype.getCoolingThresholdTemperature = function () {
    ...
    case 'heat':
    case 'cool':
        return null; // Work-around for iOS bug - Siri queries cooling threshold temperature even when not in auto mode
    default:
...
NestThermostatAccessory.prototype.getHeatingThresholdTemperature = function () {
    ...
    case 'heat':
    case 'cool':
        return null; // Work-around for iOS bug - Siri queries heating threshold temperature even when not in auto mode
    default:
