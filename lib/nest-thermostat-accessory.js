...
function NestThermostatAccessory(conn, log, device, structure, platform) {
   ...
   */
    ...
    let props = thermostatService.getCharacteristic(Characteristic.TargetTemperature).getProps;
    let props2 = thermostatService.getCharacteristic(Characteristic.TargetTemperature);
