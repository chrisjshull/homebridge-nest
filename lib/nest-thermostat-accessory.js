...
NestThermostatAccessory.prototype.setCoolingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
	...
	return Promise.resolve()
		.then(this.updateTargetWithCorrectUnitsAsync(setting, targetTemperature, "cooling threshold temperature"))
		.asCallback(callback);
}, 5000);
...
NestThermostatAccessory.prototype.setHeatingThresholdTemperatureDebounced = debounce(function (targetTemperature, callback) {
	...
	return Promise.resolve()
		.then(this.updateTargetWithCorrectUnitsAsync(setting, targetTemperature, "heating threshold temperature"))
		.asCallback(callback);
}, 5000);
