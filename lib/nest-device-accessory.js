...
var Accessory, Service, Characteristic, uuid, Away, EcoMode, EnergySaving, Fan, FanTimer;
...
module.exports = function(exportedTypes) {
    if (exportedTypes && !Accessory) {
        ...
        EnergySaving = exportedTypes.EnergySaving;
        Fan = exportedTypes.Fan;
        FanTimer = exportedTypes.FanTimer;
...
NestDeviceAccessory.prototype.isEnergySaving = function () {
    return this.device.has_leaf;
};

NestDeviceAccessory.prototype.isFan = function () {
    return this.device.fan_timer_active;
};

NestDeviceAccessory.prototype.isFanTimer = function () {
...
NestDeviceAccessory.prototype.setFan = function (fan, callback) {
    var val = fan;
...
NestDeviceAccessory.prototype.setFanTimer = function (timer, callback) {
    var val = timer;
...
NestDeviceAccessory.prototype.addEnergySavingCharacteristic = function(service) {
    service.addCharacteristic(EnergySaving);
    this.bindCharacteristic(service, EnergySaving, "Energy Saving", this.isEnergySaving);
};

NestDeviceAccessory.prototype.addFanCharacteristic = function(service) {
    service.addCharacteristic(Fan);
    this.bindCharacteristic(service, Fan, "Fan", this.isFan, this.setFan);
};

NestDeviceAccessory.prototype.addFanTimerCharacteristic = function(service) {
    service.addCharacteristic(FanTimer);
    this.bindCharacteristic(service, FanTimer, "Fan Timer", this.isFanTimer, this.setFanTimer);
};
