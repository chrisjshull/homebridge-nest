...
NestDeviceAccessory.prototype.setPropertyAsync = function(type, property, value, propertyDescription, valueDescription) {
    ...
    case 'structure': // Structure
        return this.conn.update(type + '.' + this.structureId, property, value).return(value);
    case 'device':    // Thermostat
    case 'shared':    // Thermostat
    case 'topaz':     // Protect
    case 'kryptonite':     // Temperature Sensor
        return this.conn.update(type + '.' + this.deviceId, property, value).return(value);
    default:
