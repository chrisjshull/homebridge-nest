...
NestHomeAwayAccessory.prototype.setHome = function (home, callback) {
    ...
    return this.setPropertyAsync('structure', 'away', val).asCallback(callback).finally(() => this.conn.mutex.endPropertyUpdate(this.conn.mutex.updateStates.homeAwayMode));
};
