# homebridge-nest
Nest plug-in for [Homebridge](https://github.com/nfarina/homebridge) using the native Nest API. See what's new in [release 3.3.3](https://github.com/chrisjshull/homebridge-nest/releases/tag/v3.3.3).
